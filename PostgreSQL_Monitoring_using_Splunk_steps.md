...
### ✅ Step 4: Create Inputs in "Splunk DB Connect" App and run every 5 mins. ![Postgres_Input](/PostgreSQL_Monitoring_using_Splunk/Postgres_Input.txt)

### ✅ Step 5: Create a Dashboard in Splunk ![Postgres_Dashboard](/PostgreSQL_Monitoring_using_Splunk/Postgres_Dashboard.txt)
![Postgres_Dashboard](/PostgreSQL_Monitoring_using_Splunk/Postgres_Dashboard.png)
- We can see Trends for selected timerange for each item -
![Trends in Dashboard](/Trends/Trends.png)
